        ...
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          ...
          <div className="my-12 flex items-center gap-5">
            <Link
              ...
              target='_blank'
              className="transition-all text-[#957eb4] hover:scale-125 duration-300"
            >
              <BsGithub size={30} />
            </Link>
            <Link
          ...
          <div className="flex items-center gap-3">
            <Link href="#contact" className="bg-gradient-to-r to-[#957eb4] from-violet-600 p-[1px] rounded-full transition-all duration-300 hover:from-[#957eb4] hover:to-violet-600">
              <button className="px-3 text-xs md:px-8 py-3 md:py-4 bg-[#0e0b0f] rounded-full border-none text-center md:text-sm font-medium uppercase tracking-wider text-[#ffff] no-underline transition-all duration-200 ease-out  md:font-semibold flex items-center gap-1 hover:gap-3">
